...
export const ZOOYARD_HABITAT_THEME = {
  bushland: {
    ...
    cardGradient: 'linear-gradient(160deg, rgba(92,114,51,0.16), rgba(255,255,255,0.94))',
    accent: '#5C7233',
    accentSoft: 'rgba(92,114,51,0.14)',
  ...
  rainforest: {
    ...
    cardGradient: 'linear-gradient(160deg, rgba(34,107,77,0.16), rgba(255,255,255,0.94))',
    accent: '#226B4D',
    accentSoft: 'rgba(34,107,77,0.14)',
  ...
  savannah: {
    ...
    cardGradient: 'linear-gradient(160deg, rgba(179,127,44,0.16), rgba(255,255,255,0.94))',
    accent: '#B37F2C',
    accentSoft: 'rgba(179,127,44,0.16)',
