...
export const MATHS_ANIMALS = {
  ...
  koala: {
    ...
    questions: [
      {
        q: 'Koala Sleep and Diet Data',
        stageVariants: {
          1: 'A koala has been sleeping since 8 am. You visit at 2 pm. How many hours has it been sleeping?',
          2: 'A koala sleeps 22 hours each day. What fraction of the day is the koala awake?',
          3: 'A koala eats 500 g of eucalyptus per day. Today it ate 425 g. Express the amount eaten as a simplified fraction of the daily target.',
          4: 'It costs $15,000 per year to care for one koala. What is the approximate daily cost (to the nearest dollar)?',
          5: 'Koala joey weights at 6 months (g): 250, 310, 280, 290, 270. What is the mean weight?',
        },
        stageOptions: {
          1: ['4 hours', '5 hours', '6 hours', '7 hours'],
          2: ['1/12', '1/6', '1/4', '1/3'],
          3: ['7/10', '4/5', '17/20', '9/10'],
          4: ['$38', '$41', '$44', '$48'],
          5: ['268 g', '272 g', '276 g', '280 g'],
        },
        stageCorrect: { 1: 2, 2: 0, 3: 2, 4: 1, 5: 3 },
        stageFacts: {
          1: 'From 8 am to 2 pm = 6 hours of sleep.',
          2: 'Awake hours = 24 − 22 = 2. Fraction awake = 2/24 = 1/12.',
          3: '425 ÷ 500 = 17/20. Divide both by the HCF (25): 425/500 → 17/20.',
          4: '$15,000 ÷ 365 ≈ $41.10 ≈ $41 per day.',
          5: '(250+310+280+290+270) ÷ 5 = 1400 ÷ 5 = 280 g.',
        },
        options: ['6 hours', '1/12', '17/20', '$41'],
        correct: 2,
        fact: 'Koalas sleep up to 22 hours per day — this conserves energy because eucalyptus leaves are low in nutrition.',
      },
    ],
  },
  ...
  'sea-lion': {
    ...
    questions: [
    {
      ...
      stageVariants: {
        ...
        3: 'Fish costs $6 per kg. A sea lion eats 8 kg per day. How much does it cost to feed the sea lion for one week?',
        4: 'You spend $120 on Environment items at $15 each and $80 on Wellbeing items at $20 each. How many items did you buy altogether?',
      ...
      stageCorrect: { 1: 2, 2: 2, 3: 1, 4: 2, 5: 2 },
      stageFacts: {
        ...
        3: '8 kg × $6 = $48 per day. $48 × 7 days = $336 per week. Multiply rate × quantity × time.',
        4: '$120 ÷ $15 = 8 items. $80 ÷ $20 = 4 items. 8 + 4 = 12 items altogether.',
        5: 'Supplier A: 10 × $7 = $70/day. Supplier B: 12 × $5 = $60/day. Supplier B is cheaper by $10/day.',
      },
      options: ['24 kg', '215 kg', '$336', '12'],
      correct: 2,
