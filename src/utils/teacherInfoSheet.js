...
const EXHIBITS = {
  ...
  maths: [
    ...
    {
      name: 'Sumatran Tiger',
      obs:  'Open observation - patterns, shapes and numbers in the habitat',
      focusByStage: {
        1: 'Spotting numbers, patterns and shapes in the natural environment',
        2: 'Pattern recognition; scale comparison and estimation in context',
        3: 'Scale and measurement problems; identifying mathematical relationships in real contexts',
        4: 'Scale factors, measurement and spatial reasoning applied to animal dimensions',
        5: 'Scale modelling; measurement analysis; algebraic reasoning with biological data',
      },
      tagsByStage: {
        1: ['Patterns', 'Number', 'Space'],
        2: ['Patterns', 'Scale', 'Measurement'],
        3: ['Scale', 'Measurement', 'Patterns & Algebra'],
        4: ['Scale', 'Measurement', 'Spatial Reasoning'],
        5: ['Scale Modelling', 'Algebraic Reasoning', 'Measurement'],
      },
    },
    {
      name: 'Koala',
      ...
      focusByStage: {
        1: 'Counting; simple time concepts (hours sleeping vs. active)',
        2: 'Multiplication in context; calculating food quantities and time problems',
        3: 'Fractions of time (18 of 24 hours); percentage of day; multi-step calculations',
        4: 'Financial mathematics; rates (cost per animal per year); percentage of time asleep',
        5: 'Financial maths with compound values; rate calculations; percentage change in conservation budgets',
      },
      tagsByStage: {
        1: ['Time', 'Number', 'Counting'],
        2: ['Multiplication & Division', 'Time', 'Number'],
        3: ['Fractions', 'Percentages', 'Multi-step Problems'],
        4: ['Financial Mathematics', 'Rates', 'Percentages'],
        5: ['Financial Mathematics', 'Compound Rates', 'Percentage Change'],
      },
    },
    {
      name: 'Dingo',
      ...
      focusByStage: {
        1: 'Counting; simple addition and subtraction in context',
        2: 'Multiplication - calculating total territory from per-animal area needs',
        3: 'Area problems; multi-step calculations; comparing estimated and actual territory ranges',
        4: 'Multiplicative reasoning; area and rates applied to territory; food chain energy maths',
        5: 'Mathematical modelling of territory requirements; energy transfer percentages in food webs',
      },
      tagsByStage: {
        1: ['Counting', 'Addition & Subtraction', 'Number'],
        2: ['Multiplication & Division', 'Area', 'Number'],
        3: ['Area', 'Multi-step Problems', 'Multiplication & Division'],
        4: ['Area', 'Rates', 'Multiplicative Reasoning'],
        5: ['Mathematical Modelling', 'Area', 'Percentages'],
      },
    },
    {
      name: 'Ring-tailed Lemur',
    ...
    },
    {
      ...
      focusByStage: {
        1: 'Comparing sizes; bigger and smaller using numbers',
        2: 'Calculating differences in mass; simple rate problems (days of food from a given supply)',
        3: 'Rates and multiplication; financial calculations and mass comparison problems',
        4: 'Financial mathematics - rates and unit cost calculations; mass and proportion in context',
        5: 'Financial maths with rates; percentage cost calculations; data interpretation for conservation',
      },
      tagsByStage: {
        1: ['Measurement', 'Comparison', 'Number'],
        2: ['Measurement', 'Rates', 'Subtraction'],
        3: ['Rates', 'Financial Mathematics', 'Measurement'],
        4: ['Financial Mathematics', 'Rates', 'Measurement'],
        5: ['Financial Mathematics', 'Rates', 'Data Interpretation'],
      },
    },
    {
      name: 'Asian Water Buffalo',
