const DOCS = {
  privacy: {
    ...
    sections: [
      { type: 'intro', text: 'Taronga Tracka is an educational wildlife tracking app designed for use at Taronga Zoo, Sydney, by school groups and the general public. This Privacy Policy explains how we collect, use, and protect information when you use the app.\n\nIf you have questions, contact us at cameron.rodgers3@det.nsw.edu.au' },
      { type: 'heading', text: '1. Who We Are' },
      { type: 'body', text: 'Taronga Tracka is an independent educational platform developed in partnership with Taronga Conservation Society Australia. The app is operated by Cameron King (Biology Bloke Education). References to "we", "us" or "our" in this policy refer to the app operator.\n\nWe are committed to complying with the Privacy Act 1988 (Cth) and the Australian Privacy Principles (APPs).' },
      { type: 'heading', text: '2. Our Privacy-by-Design Approach' },
      { type: 'body', text: 'Student anonymity is built in. Taronga Tracka does not collect or store student names. Students participate using a self-selected animal alias (e.g. "Red Kangaroo" or "Quokka"). The link between a student\'s real name and their alias is maintained only by their teacher - it never enters our platform.\n\nThis means that the data stored in our systems cannot identify an individual student without the teacher\'s separate record. We consider this a core privacy protection, not an optional feature.' },
      ...
      { type: 'list', items: ['Email address and password (used for account sign-in)', 'School name (optional, provided at registration)', 'Class session data created and managed by the teacher'] },
      ...
      { type: 'list', items: ['All data transmitted over encrypted HTTPS connections', 'Firestore security rules restrict access so each user sees only their own data', 'Teacher accounts are verified and approved before gaining dashboard access', 'Password-based authentication with admin approval before dashboard access is granted', 'Student data stored under anonymous aliases, not real names'] },
      ...
      { type: 'body', text: 'If you believe we have not handled your personal information appropriately, please contact us first. We will respond within 30 days.' },
      { type: 'body', text: 'If you remain dissatisfied, you may lodge a complaint with the Office of the Australian Information Commissioner (OAIC):\nWebsite: www.oaic.gov.au\nPhone: 1300 363 992' },
